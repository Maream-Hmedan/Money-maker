...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  final CountriesController _countriesController = Get.put(
    CountriesController(),
  );
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        if (didPop) {
          _profileController.resetToOriginalData();
        }
      },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFieldWidget(
                        ...
                        onSubmitted:
                            (v) => _companyNameFocusNode.requestFocus(),
                        validator: (v) {
                          if (v == null || v.isEmpty) {
                      ...
                      SizedBox(height: AppSize.heightBetweenTextField),
                      TextFieldWidget(
                        controller: _profileController.companyNameController,
                        ...
                        builder: (controller) {
                          ...
                          return IgnorePointer(
                            ...
                            child: DropdownSearch<Countries>(
                              ...
                              enabled:
                                  _countriesController.countries.isNotEmpty,
                              onChanged: (value) {
                                setState(() {
                              ...
                              dropdownDecoratorProps: DropDownDecoratorProps(
                                dropdownSearchDecoration: InputDecoration(
                                  labelText: S.of(context).selectCountry,
                      ...
                      ButtonWidget(
                        ...
                        onTap: () async {
                          ...
                          if (_key.currentState!.validate()) {
                            await _profileController.editProfileData(
                              fullName:
                                  _profileController.nameController.text.trim(),
                              email:
                              ...
                              mobile:
                                  _profileController.phoneController.text
                                      .trim(),
                              companyName:
                                  _profileController.companyNameController.text
                                      .trim(),
                            );
                          }
                        },
