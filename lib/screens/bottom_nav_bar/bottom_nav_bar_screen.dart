...
import 'package:money_maker/screens/top/view/top_screen.dart';
...
class _BottomNavBarScreenState extends State<BottomNavBarScreen> {
  ...
  final List<BottomTabModel> _bottomTabs = [
    ...
    BottomTabModel(icon: const Icon(Icons.person), view: ProfileScreen()),
    BottomTabModel(icon: const Icon(Icons.emoji_events), view: TopPlayersPage(showAppBar: false,)),
  ...
  Widget _persistentTabBar() {
    return PersistentTabView(
      ...
      items: [
        ...
        _navItem(Icons.person,S.of(context).myProfile),
